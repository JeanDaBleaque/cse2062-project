...
public class DatabaseManager {
    ...
    public boolean addInstructor(Instructor instructor) {
        try {
            PreparedStatement userStatement = connection.prepareStatement("INSERT INTO users (name, surname, email, phone, address, password, status, created_at, updated_at, role, id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
